...
class PackageLoader
{
    ...
    public function loadPackage($directory)
    {
        ...
        if (!is_subclass_of($namespace.'Package', 'NewUp\\Templates\\BasePackageTemplate')) {
            throw new NewUpException("The 'Package' class must extend 'NewUp\\Templates\\BasePackageTemplate'");
        }
